...
var signup = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                user = _a.sent();
                token = (0, utils_1.signToken)(user.id);
                res.status(201).json({
                    status: 'success',
                    data: {
                        user: user,
...
var login = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, password, user, isCorrectPassword, token, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, (0, utils_1.checkPassword)(password, user.password)];
            case 3:
